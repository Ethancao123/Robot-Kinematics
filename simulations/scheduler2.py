...
def print_some_times():
    ...
    s.enter(2/mult, 2, activity_1)
    s.enter(12/mult, 1, activity_1_end)
    s.enter(5/mult, 3, activity_2, argument=('positional',))
    s.enter(7/mult, 1, activity_2_end, argument=('end',))
    s.enter(5/mult, 2, activity_3, kwargs={'a': 'keyword'})
    s.enter(6/mult, 2, activity_3_end, kwargs={'a': 'end'})
    s.run()
    s.run()
    s.enter(8/mult, 1, activity_1_end)
    s.run()
